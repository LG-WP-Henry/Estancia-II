...
foreach ($preguntas_seleccionadas as $id_pregunta) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<script>alert('El test fue asignado');window.location.href='../Vista/crudActividades/altaActividad.php';</script>";
    } else {
        //echo "Error: " . $sql . "<br>" . $conn->error;
        echo "<script>alert('Error al asignar test');window.location.href='../Vista/crudActividades/altaActividad.php';</script>";
    }
}
$conn->close();
//sleep(3);
