...
$sql = "UPDATE avances SET Observaciones = '$observaciones' WHERE IdPacienteAv = $idPaciente AND CedulaAv = '$cedulaPsicologo' AND (Observaciones IS NULL OR Observaciones = '')";
